...
Examples:
  src/scripts/run_flag_variants.sh data/cvfg/v13/cvfg_variants.18.tsv data/cvfg/v13/cvfg_variants.19.tsv
...
# step_19, which runs from a variant-annotation checkout.
